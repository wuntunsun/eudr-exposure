...
def gem_data_for_ml(gem_data):
    ...
    df_gem['start_year'] = pd.to_numeric(df_gem['start_year'], errors='coerce') 
    ...
    cols_to_keep = ['latitude', 'longitude', 'uid_gem', 'sector', 'start_year', 'capacity', 'capacity_unit', 'asset_name']
    ...
    cols_agg = ['latitude', 'longitude', 'uid_gem', 'sector', 'capacity_unit', 'asset_name']
